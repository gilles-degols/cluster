...
class UnrespondingManager(message: String) extends ClusterException(message)
class MissingManager(message: String) extends ClusterException(message)
class MissingPackageLeader(message: String) extends ClusterException(message)
